          ...
          <div className="flex items-center gap-2 sm:gap-3">
             ...
             {deferredPrompt && (
               <button
                ...
                className="hidden md:flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-brand-700 bg-brand-50 border border-brand-200 rounded-md hover:bg-brand-100 transition-colors animate-pulse"
                title="安裝到電腦"
              >
                <MonitorDown size={16} />
                <span>安裝程式</span>
